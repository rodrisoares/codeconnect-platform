...
export class CommentResponseDto {
  ...
  @ApiPropertyOptional({
    example: null,
    description: 'ID do comentário pai (nulo quando é um comentário raiz)',
    nullable: true,
  })
  ...
  @ApiPropertyOptional({
    ...
    description: 'Respostas a este comentário (apenas em comentários raiz)',
  })
  replies?: CommentResponseDto[];

  @ApiPropertyOptional({ example: 3, description: 'Quantidade de curtidas' })
  likesCount?: number;

  @ApiPropertyOptional({
    example: false,
    description: 'Indica se o usuário autenticado curtiu o comentário',
  })
  likedByMe?: boolean;
}
